...
ordinary differential equations and integration was performed
...
differences \citep{ByrneHindmarsh1975}. The sum state variable in the
Markov scheme describing the resurgent sodium current
...
\begin{figure}[!ht]
  \include{spikes}
  \caption{\textbf{Simple spikes in the three- and five-current models}.}
 \end{figure}
