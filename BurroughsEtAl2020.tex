...
The three-channel and five-channel model were tested. After fitting
those parameters that are not known from experiment, the three-channel
model simulates complex spikes whose structure exhibits those features
which are broadly typical to Purkinje cells; the five-channel model in
...
waveform observed in numerous studies, both \textsl{in vitro}
\cite{ZaghaEtAl2008, zhang2017ethanol, MonsivaisEtAl2005,
  khaliq2005axonal} and \textsl{in vivo} \cite{WarnaarEtAl2015},
though these studies are less common. These feature, which are broadly
stereotypical are
\begin{enumerate}
...
use as a target for model fitting.


However, complex spikes do exhibit large amounts of variablity
\cite{BurroughsEtAl2016, WarnaarEtAl2015}. Interestingly both the
three- and five-channel models presented in the current study can be
