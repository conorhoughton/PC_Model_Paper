...
g_rna  = 105*mS # original in paper
#g_rna  = 90*mS
#g_rna = 80*mS+40*mS*rnd.random()
g_k   =  15*mS  # original in paper
...
class Electrode():
    ...
    def __init__(self,cf_a,i0):
        self.cf_a=cf_a
        self.background_current=i0
    ...
    def __call__(self,t):
        ...
        for t_ss in ss_times:
            if t>t_ss and t<t_ss+ss_duration:
                return self.background_current+pf_a*pf_synapse(t-t_ss)
        for t_in in in_times:
            if t>t_in and t<t_in+in_duration:
                return self.background_current+in_a*in_synapse(t-t_in)
