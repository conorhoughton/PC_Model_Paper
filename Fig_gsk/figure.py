...
voltage_100_ms = np.loadtxt('voltage_100.txt')
voltage_120_ms = np.loadtxt('voltage_120.txt')
voltage_140_ms = np.loadtxt('voltage_140.txt')

voltage_100 = [x[1]*1000 for x in voltage_100_ms]
voltage_120 = [x[1]*1000 for x in voltage_120_ms]
voltage_140 = [x[1]*1000 for x in voltage_140_ms]

# sampling_rate=0.0025
sampling_rate=0.001
times = [x[0] for x in voltage_140_ms]
...
plt.plot(times[t1:t2], voltage_100[t1:t2], 'k')
...
plt.plot([x for x in times[t1:t2]], voltage_120[t1:t2], 'k')
...
plt.plot(times[t1:t2], voltage_140[t1:t2], 'k')
...
plt.text(0.0,385,'A', fontsize=16)
plt.text(0.0,215,'B', fontsize=16)
plt.text(0.0,45 ,'C', fontsize=16)


plt.text(0.05,375,'$g_{\mathrm{sk}}=100\,$mS', fontsize=12)
plt.text(0.05,205,'$g_{\mathrm{sk}}=120\,$mS', fontsize=12)
plt.text(0.05,35 ,'$g_{\mathrm{sk}}=140\,$mS', fontsize=12)
