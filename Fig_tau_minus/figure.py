...
voltage_5_ms = np.loadtxt('voltage_5.txt')
voltage_8_ms = np.loadtxt('voltage_8.txt')
voltage_12_ms = np.loadtxt('voltage_12_cf20.txt')

voltage_5 = [x[1]*1000 for x in voltage_5_ms]
voltage_8 = [x[1]*1000 for x in voltage_8_ms]
voltage_12 = [x[1]*1000 for x in voltage_12_ms]

# sampling_rate=0.0025
sampling_rate=0.001
times = [x[0] for x in voltage_8_ms]
...
plt.plot([x for x in times[t1:t2]], voltage_8[t1:t2], 'k')
...
plt.plot(times[t1:t2], voltage_12[t1:t2], 'k')
...
plt.savefig('figure_tau_minus.jpg', dpi=900)
plt.show()
